...
| 12 | The Prompts That Build Silver Tier (Including Prompt 0 — Source Analysis) |
...
> Playwright se aap apne personal WhatsApp Web ko automate karte hain — free aur simple.
...
> Yeh WhatsApp ki taraf se hota hai — hamara code nahi rok sakta.
...
> Socho aapke paas ek bhari almari hai (171MB — googleapis package).
> Agar aap office mein aate hi almari ko uthane lagein → 30 second lag jaayein →
> boss samjhe ga aap nahi aaye (timeout).
>
> Lazy import = Pehle aao, baithoo, available ho jao (server start).
> Almari tab uthao jab kaam aaye (tool call).
> Boss dekhta hai aap time pe aa gaye ✅
...
>
> Aap plan dekhein — theek hai to approve karein, galat hai to reject karein.
...
> **Roman Urdu:**
> WhatsApp Web wahi hai jo aap browser mein use karte hain.
...
Haan — WhatsApp Web ke through. Jaise aap browser mein WhatsApp Web use karte hain,
...
start karta hai. Aap sirf Claude Code start karein — MCP khud connect ho jata hai.
